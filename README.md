...
**GitHub + Supabase:** `docs/GITHUB_VE_SUPABASE.md` · **Görsel yükleme (Storage):** `docs/SUPABASE_STORAGE.md`  
Hızlı push: `scripts/push-to-github.sh`. CI şablonu: `docs/github-actions-ci.yml`.
