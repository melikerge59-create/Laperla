...
# -u kullanma: upstream'e token'li URL yazilir; push sonrasi origin + upstream temizlenir
git push "https://melikerge59-create:${GITHUB_TOKEN}@github.com/melikerge59-create/Laperla.git" main
git remote set-url origin "$REPO_URL"
